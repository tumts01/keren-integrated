...
const STANDARD_KEYS = [
  'ID SISWA', 'NAMA', 'NISM', 'NISN', 'NIK', 'NRP', 'USIA', 'TEMPAT, TANGGAL LAHIR', 'JENIS KELAMIN',
  'DOMISILI', 'STATUS SISWA', 'ANAK KE-', 'STATUS ANAK', 'STATUS TEMPAT TINGGAL SISWA',
  'ALAMAT ASAL SESUAI KK TERAKHIR', 'NOMOR KK', 'JUMLAH SAUDARA',
  'TRANSPORTASI KE SEKOLAH', 'JARAK TEMPAT TINGGAL - MADRASAH/SEKOLAH', 'WAKTU TEMPUH', 'Alamat E-Mail',
  'NAMA AYAH KANDUNG', 'NIK AYAH KANDUNG', 'TTL AYAH KANDUNG', 'STATUS AYAH KANDUNG',
  'PEKERJAAN AYAH KANDUNG', 'PENDIDIKAN TERAKHIR AYAH KANDUNG', 'PENGHASILAN RATA-RATA PER BULAN AYAH KANDUNG',
  'NOMOR TELEPON AYAH KANDUNG', 'ALAMAT AYAH KANDUNG',
  'NAMA IBU KANDUNG', 'NIK IBU KANDUNG', 'TTL IBU', 'STATUS IBU KANDUNG',
  'PEKERJAAN IBU KANDUNG', 'PENDIDIKAN TERAKHIR IBU KANDUNG', 'PENGHASILAN RATA-RATA PER BULAN IBU KANDUNG',
  'NOMOR TELEPON IBU KANDUNG', 'ALAMAT IBU KANDUNG',
  'NAMA WALI', 'NIK WALI', 'TTL WALI', 'STATUS WALI', 'PEKERJAAN WALI', 'PENDIDIKAN TERAKHIR WALI',
  'PENGHASILAN RATA-RATA PER BULAN WALI', 'NOMOR TELEPON WALI', 'ALAMAT WALI',
  'SD/MI', 'NPSN SD/MI', 'ALAMAT SD/MI', 'TAHUN LULUS SD/MI', 'NO SERI IJAZAH SD/MI',
  'TANGGAL MASUK MTs/SMP', 'DITERIMA DI MTs KELAS', 'TAHUN AJARAN', 'ROMBEL',
  'TA KELAS 7', 'ROMBEL KELAS 7', 'TA MUTASI KELAS 7',
  'TA KELAS 8', 'ROMBEL KELAS 8', 'TA MUTASI KELAS 8',
  'TA KELAS 9', 'ROMBEL KELAS 9',
  'TAHUN BUKU INDUK', 'KIP', 'IJAZAH', 'NO. SERI IJAZAH MTs',
  'SMP/MTs SEBELUMNYA', 'NPSN/NSS/NSM SMP/MTs SEBELUMNYA', 'NOMOR SURAT MUTASI MASUK', 'TANGGAL MUTASI MASUK',
  'TANGGAL MUTASI KELUAR', 'NOMOR SURAT MUTASI KELUAR', 'SMP/MTs TUJUAN', 'NPSN/NSM SMP/MTs TUJUAN', 'TANGGAL KELUAR',
  'SMA/MA/SMK/MAK LANJUTAN', 'NPSN SMA/MA/SMK/MAK LANJUTAN',
