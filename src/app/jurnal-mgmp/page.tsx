...
export default function JurnalMgmpPage() {
      ...
      <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1e293b', marginBottom: '4px' }}>
            <i className="fas fa-users-cog" style={{ marginRight: '10px', color: '#0ea5e9' }}></i>
            Jurnal MGMP
          </h1>
          <p style={{ color: '#64748b', margin: 0 }}>Pencatatan kegiatan Musyawarah Guru Mata Pelajaran (MGMP)</p>
        </div>
        <button
        ...
        >
          <i className="fas fa-plus"></i> Tambah Jurnal
        </button>
      </div>
