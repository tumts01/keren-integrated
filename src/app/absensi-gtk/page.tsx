...
export default function AbsensiGTK() {
  ...
  // States for Admin Edit Absen (Inline)
  ...
  // Koordinat sekolah (MTs Almaarif 01 Singosari) — diambil langsung dari Google Maps
  const SCHOOL_LAT = -7.892338;
  const SCHOOL_LNG = 112.665019;
    ...
    <div className={styles.container}>
      ...
      {activeTab === 'absen' && (
        <div style={{ maxWidth: '600px', margin: '0 auto', position: 'relative', marginTop: '160px' }}>
          ...
          <div style={{ position: 'absolute', bottom: 'calc(100% - 4px)', left: '50%', transform: 'translateX(-50%)', width: '250px', height: '444px', zIndex: 0, pointerEvents: 'none' }}>
